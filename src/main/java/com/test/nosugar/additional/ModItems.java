...
public class ModItems {
    ...
    //これを見てる人へ v2で実装予定だから他の人に言わんでくれ
    /*public static final RegistryObject<Item> NOSUGAR =
            ITEMS.register("nosugar", () -> new NoSugar_Item(new Item.Properties().stacksTo(1)));*/
    ...
    public static final RegistryObject<Item> HALO_OF_SUGAR_DUMMY1 =
            DUMMY_ITEMS.register("halo_of_sugar_layer1", () -> new Halo_of_Sugar_item(new Item.Properties().stacksTo(1)));
